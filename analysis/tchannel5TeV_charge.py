...
#        '2j1b_DRlu' : processor.column_accumulator(np.array([])),
    ...
    def process(self, events):
        ...
        selections.add("e_minus", ( (events.ise)&(trige)&(events.isl_minus)))
        selections.add("m_minus", ( (events.ism)&(trigm)&(events.isl_minus)))
        selections.add("e_fake_minus", ( (events.ise_fake)&(trige)&(events.isl_minus_fake)))
        selections.add("m_fake_minus", ( (events.ism_fake)&(trigm)&(events.isl_minus_fake)))
        selections.add("e_plus", ( (events.ise)&(trige)&(events.isl_plus)))
        selections.add("m_plus", ( (events.ism)&(trigm)&(events.isl_plus)))
        selections.add("e_fake_plus", ( (events.ise_fake)&(trige)&(events.isl_plus_fake)))
        selections.add("m_fake_plus", ( (events.ism_fake)&(trigm)&(events.isl_plus_fake)))        
