...
fake_rates={('e_minus','2j1b'):0.4998,
	...
	('e_minus','3j2b'):0.612,
	('e_plus','3j2b'):0.451,
	('m_minus','3j2b'):0.153,								#These are the Fake rates (parte denominador)
	('m_plus','3j2b'):0.209,
		}
...
fake_rates_ll={('e_minus','2j1b'):1.368,
	('e_plus','2j1b'):1.368,
	('m_minus','2j1b'):0.029,
	('m_plus','2j1b'):0.029,
	('e_minus','3j1b'):1.368,
	...
	('e_minus','3j2b'):1.368,
	('e_plus','3j2b'):1.368,
	('m_minus','3j2b'):0.029,								#These are the Fake rates (parte denominador)
	('m_plus','3j2b'):0.029,
		}
fake_rates_lh={('e_minus','2j1b'):1.046,
	('e_plus','2j1b'):1.046,
	('m_minus','2j1b'):0.113,
	('m_plus','2j1b'):0.113,
	('e_minus','3j1b'):1.046,
	...
	('e_minus','3j2b'):1.046,
	('e_plus','3j2b'):1.046,
	('m_minus','3j2b'):0.113,								#These are the Fake rates (parte denominador)
	('m_plus','3j2b'):0.113,
		}
fake_rates_hl={('e_minus','2j1b'):0.392,
	('e_plus','2j1b'):0.392,
	('m_minus','2j1b'):0.087,
	('m_plus','2j1b'):0.087,
	('e_minus','3j1b'):0.392,
	...
	('e_minus','3j2b'):0.392,
	('e_plus','3j2b'):0.392,
	('m_minus','3j2b'):0.087,								#These are the Fake rates (parte denominador)
	('m_plus','3j2b'):0.087,
		}
fake_rates_hh={('e_minus','2j1b'):0.384,
	('e_plus','2j1b'):0.384,
	('m_minus','2j1b'):0.100,
	('m_plus','2j1b'):0.100,
	('e_minus','3j1b'):0.384,
	...
	('e_minus','3j2b'):0.384,
	('e_plus','3j2b'):0.384,
	('m_minus','3j2b'):0.100,								#These are the Fake rates (parte denominador)
	('m_plus','3j2b'):0.100,
		}
		
joint_rates_ll={key: fake_rates_ll[key] * cr_rates[key]/302 for key in fake_rates_ll} 
joint_rates_lh={key: fake_rates_lh[key] * cr_rates[key]/302 for key in fake_rates_lh} 
joint_rates_hl={key: fake_rates_hl[key] * cr_rates[key]/302 for key in fake_rates_hl} 
...
for name, hist in modified_hists.items():
	if isinstance(hist, Hist):  # Ensure it's a coffea Hist object
		...
		if name in ['MVAscore_relaxed_b10_ll','absu0eta_ll']:joint_rates=joint_rates_ll
		elif name in ['MVAscore_relaxed_b10_lh','absu0eta_lh']:joint_rates=joint_rates_lh
		elif name in ['MVAscore_relaxed_b10_hl','absu0eta_hl']:joint_rates=joint_rates_hl
		elif name in ['MVAscore_relaxed_b10_hh','absu0eta_hh']:joint_rates=joint_rates_hh   #Renombrando los FRs por cada una de las partes
		...
		if 'channel' in hist.axes() and 'level' in hist.axes():
			for (channel, level), fake_rate in joint_rates.items():
				...
				if name=='MVAscore_relaxed_b10': intsplit=integral
				if name in ['MVAscore_relaxed_b10_ll','MVAscore_relaxed_b10_lh','MVAscore_relaxed_b10_hl','MVAscore_relaxed_b10_hh']: integral=intsplit  #TRUCO: para que coincida la suma con las partes separadas (imaginando que multiplicamos por el mismo FR), 
																																						 #hemos de usar como integral al hacer la division la del total, y no la de cada una de las partes separadas
				if name=='absu0eta': intsplit_2=integral
				if name in ['absu0eta_ll','absu0eta_lh','absu0eta_hl','absu0eta_hh']: integral=intsplit_2
...
## UP to here works ##################################################################				
				if need_to_cut:
					...
					if name=='MVAscore_relaxed_b10_ll_cut':hist.values()['QCD',channel,level,'norm'][:10]=np.zeros(10);hist.values()['QCD',channel,level,'norm'][-10:]=modified_hists['MVAscore_relaxed_b10_ll'].values()['QCD',channel,level,'norm'][-10:]
					elif name=='MVAscore_relaxed_b10_lh_cut':hist.values()['QCD',channel,level,'norm'][:10]=np.zeros(10);hist.values()['QCD',channel,level,'norm'][-10:]=modified_hists['MVAscore_relaxed_b10_lh'].values()['QCD',channel,level,'norm'][-10:]
					elif name=='MVAscore_relaxed_b10_hl_cut':hist.values()['QCD',channel,level,'norm'][:10]=np.zeros(10);hist.values()['QCD',channel,level,'norm'][-10:]=modified_hists['MVAscore_relaxed_b10_hl'].values()['QCD',channel,level,'norm'][-10:]
					elif name=='MVAscore_relaxed_b10_hh_cut':hist.values()['QCD',channel,level,'norm'][:10]=np.zeros(10);hist.values()['QCD',channel,level,'norm'][-10:]=modified_hists['MVAscore_relaxed_b10_hh'].values()['QCD',channel,level,'norm'][-10:]
