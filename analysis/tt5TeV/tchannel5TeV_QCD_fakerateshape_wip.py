...
class AnalysisProcessor(processor.ProcessorABC):
    ...
    def __init__(self, samples, model):
        ...
        'j0pt_ll'       : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("j0pt_ll",  "Leading jet $p_{T}$ (GeV) (ll)", 10, 0, 300)),
        'j0pt_lh'       : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("j0pt_lh",  "Leading jet $p_{T}$ (GeV) (lh)", 10, 0, 300)),
        'j0pt_hl'       : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("j0pt_hl",  "Leading jet $p_{T}$ (GeV) (hl)", 10, 0, 300)),
        'j0pt_hh'       : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("j0pt_hh",  "Leading jet $p_{T}$ (GeV) (hh)", 10, 0, 300)),
        ...
        'mjj'        : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("mjj",     "m(jj)( (GeV)", 24, 0, 480)),
        ...
        'MVAscore_relaxed_b10_ll'     : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("MVAscore_relaxed_b10_ll", "MVA score", 20,0,1 )),
        'MVAscore_relaxed_b10_lh'     : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("MVAscore_relaxed_b10_lh", "MVA score", 20,0,1 )),
        'MVAscore_relaxed_b10_hl'     : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("MVAscore_relaxed_b10_hl", "MVA score", 20,0,1 )),
        'MVAscore_relaxed_b10_hh'     : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("MVAscore_relaxed_b10_hh", "MVA score", 20,0,1 )),
...
########## Hists I added
        'ht_atlas'         : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("ht_atlas",      "H'$_{T}$ (GeV)", 29, 5, 435)),
        ...
        'mlb'         : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("mlb",      "m$_{\ell b}$ (GeV)", 24, 0, 480)),
        ...
        'deltaeta'         : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("deltaeta",      '|$\Delta\eta(\mathrm{u_{0},b_{0}})$|', 16, 0, 5.0)),
        ...
        'ht_atlas_nocut'         : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("ht_atlas_nocut",      "H'$_{T}$ (GeV)", 10, 0, 340)),
...
#        'costm_3'         : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("costm_3",      " cos($\Theta^{*}$) ", 15, -1, 1)),          
        ...
        'mub'        : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("mub",     "m(u,b) (GeV)", 24, 0, 480)),
...
#        '2j1b_DRlu' : processor.column_accumulator(np.array([])),
        ...
        '2j1b_btagsf' : processor.column_accumulator(np.array([])),
        '2j1b_btagscore' : processor.column_accumulator(np.array([])),
        '2j1b_jeteta' : processor.column_accumulator(np.array([])),
    ...
    def process(self, events):
        ...
        # Muon selection
        mu["isLoose"] = MuonLoose(mu.pt, mu.eta, mu.dxy, mu.dz, mu.sip3d, mu.mediumPromptId, mu.btagDeepB, ptCut=20, etaCut=2.4)#mediumPromptId
        ...
        e['isLoose'] = ElecLoose(e.pt, e.eta, e.lostHits, e.sip3d, e.dxy, e.dz, e.btagDeepB, e.convVeto, e.mvaFall17V2noIso_WPL, 20, 2.4)#mvaFall17V2noIso_WPL
        ...
        m_pdgId_new=ak.firsts(mu.pdgId)
        e_pdgId_new=ak.firsts(e.pdgId)
        

        m_sel_plus=mu[mu.isLoose & mu.isMVA & (m_pdgId_new<0)]
        e_sel_plus=e[e.isLoose & e.isMVA & (e_pdgId_new<0)]
        m_sel_minus=mu[mu.isLoose & mu.isMVA & (m_pdgId_new>0)]
        e_sel_minus=e[e.isLoose & e.isMVA & (e_pdgId_new>0)]
        m_fake_plus=mu[mu.isLoose & (mu.isMVA==0) & (m_pdgId_new<0)]
        e_fake_plus=e[e.isLoose & (e.isMVA==0) & (e_pdgId_new<0)]
        m_fake_minus=mu[mu.isLoose & (mu.isMVA==0) & (m_pdgId_new>0)]
        e_fake_minus=e[e.isLoose & (e.isMVA==0) & (e_pdgId_new>0)]


        e0 = e_sel[ak.argmax(e_sel.pt,axis=-1,keepdims=True)]
        m0 = m_sel[ak.argmax(m_sel.pt,axis=-1,keepdims=True)]
        
        e0_pdgId_new=ak.flatten(ak.fill_none(e0.pdgId,0))
        m0_pdgId_new=ak.flatten(ak.fill_none(m0.pdgId,0))      
        
        e_fake0 = e_fake[ak.argmax(e_fake.pt,axis=-1,keepdims=True)]
        m_fake0 = m_fake[ak.argmax(m_fake.pt,axis=-1,keepdims=True)]

        e_fake0_pdgId_new=ak.flatten(ak.fill_none(e_fake0.pdgId,0))
        m_fake0_pdgId_new=ak.flatten(ak.fill_none(m_fake0.pdgId,0))
        
        
        e_plus0 = e_sel_plus[ak.argmax(e_sel_plus.pt,axis=-1,keepdims=True)]        
        e_minus0 = e_sel_minus[ak.argmax(e_sel_minus.pt,axis=-1,keepdims=True)]
        m_plus0 = m_sel_plus[ak.argmax(m_sel_plus.pt,axis=-1,keepdims=True)]        
        m_minus0 = m_sel_minus[ak.argmax(m_sel_minus.pt,axis=-1,keepdims=True)]
        e_fake_plus0 = e_fake_plus[ak.argmax(e_fake_plus.pt,axis=-1,keepdims=True)]        
        e_fake_minus0 = e_fake_minus[ak.argmax(e_fake_minus.pt,axis=-1,keepdims=True)]
        m_fake_plus0 = m_fake_plus[ak.argmax(m_fake_plus.pt,axis=-1,keepdims=True)]        
        m_fake_minus0 = m_fake_minus[ak.argmax(m_fake_minus.pt,axis=-1,keepdims=True)]        
        ...
        events['isl_minus']=((ak.num(m_sel) == 0) & (ak.num(e_sel) == 1)&(ak.fill_none(e_pdgId_new>0,False)))|((ak.num(m_sel) == 1) & (ak.num(e_sel) == 0)&(ak.fill_none(m_pdgId_new>0,False)))
        events['isl_plus']=((ak.num(m_sel) == 0) & (ak.num(e_sel) == 1)&(ak.fill_none(e_pdgId_new<0,False)))|((ak.num(m_sel) == 1) & (ak.num(e_sel) == 0)&(ak.fill_none(m_pdgId_new<0,False)))
        events['isl_minus_fake']=((ak.num(m_sel) == 0) & (ak.num(e_sel) == 0) & (ak.num(e_fake) == 1)&(ak.fill_none(e_pdgId_new>0,False)))|((ak.num(m_sel) == 0) & (ak.num(e_sel) == 0)& (ak.num(m_fake) == 1)&(ak.fill_none(m_pdgId_new>0,False)))
        events['isl_plus_fake']=((ak.num(m_sel) == 0) & (ak.num(e_sel) == 0)& (ak.num(e_fake) == 1)&(ak.fill_none(e_pdgId_new<0,False)))|((ak.num(m_sel) == 0) & (ak.num(e_sel) == 0)& (ak.num(m_fake) == 1)&(ak.fill_none(m_pdgId_new<0,False)))        
        ...
        if not isData:
          ...
          #print('\n b tag SF',*btagSF,'\n nuevos SF',*btagSF_nuevos,'\n eta',*nuevosjets.eta,'\n btagdeepb',*nuevosjets.btagDeepB,'\n')
          
          
          #flateta=ak.flatten(goodJets.eta)
          #print('jet pt',*goodJets.eta,'\n corte',*corteeta,'\n suma',sum(corteeta),'\n',len(corteeta),len(flateta),len(btagSF),'\n')
          #print('cortados',flateta[corteeta],btagSF[corteeta],'\n')  #aplicar btagsf5tev solo a eventos cortados
        ...
        for ch_name in ["em", "e_plus","e_minus", "m_plus","m_minus", 'ee', 'mm']:
        ...
        if not isData and not isSystSample: systList = systList + ["elecSFUp","elecSFDown", "muonSFUp", "muonSFDown", "btagSFlightUp","btagSFlightDown","btagSFbcUp","btagSFbcDown",  "prefireUp", "prefireDown", "trigSFUp", "trigSFDown"]+systJets#, "trigSFUp", "trigSFDown"] + systJets
        ...
        selections.add("e_minus", ( (events.ise)&(trige)&(events.isl_minus)&(lumi_mask)))
        selections.add("m_minus", ( (events.ism)&(trigm)&(events.isl_minus)&(lumi_mask)))
        selections.add("e_fake_minus", ( (events.ise_fake)&(trige)&(events.isl_minus_fake)&(lumi_mask)))
        selections.add("m_fake_minus", ( (events.ism_fake)&(trigm)&(events.isl_minus_fake)&(lumi_mask)))
        selections.add("e_plus", ( (events.ise)&(trige)&(events.isl_plus)&(lumi_mask)))
        selections.add("m_plus", ( (events.ism)&(trigm)&(events.isl_plus)&(lumi_mask)))
        selections.add("e_fake_plus", ( (events.ise_fake)&(trige)&(events.isl_plus_fake)&(lumi_mask)))
        selections.add("m_fake_plus", ( (events.ism_fake)&(trigm)&(events.isl_plus_fake)&(lumi_mask)))        
       # selections.add('lep_plus',((events.isl_plus)&((trige)|(trigm))))
        ...
        channels=['e_plus','m_plus','e_fake_plus','m_fake_plus','e_minus','m_minus','e_fake_minus','m_fake_minus']
        ...
        for syst in systList:
          ...
          for ch in channels:
            ...
            if ch in ['e_fake_plus', 'm_fake_plus','e_fake_minus','m_fake_minus']:
...
#              cutdeltaetal=abs(b0eta-u0eta)>1.5
 #             cutdeltaeta=ak.Array(cutdeltaetal)
  #            cutdeltaeta=ak.fill_none(cutdeltaeta,False)  #For adding the difference in eta bt b and u jets cut (me)
              ...
              lep_pt=ak.where(ak.is_none(lep_pt),ak.Array([[None]]),lep_pt)
              lep_energy=ak.where(ak.is_none(lep_energy),ak.Array([[None]]),lep_energy)
              lep_phi=ak.where(ak.is_none(lep_phi),ak.Array([[None]]),lep_phi)
              lep_eta=ak.where(ak.is_none(lep_eta),ak.Array([[None]]),lep_eta)
              lep_mass=ak.where(ak.is_none(lep_mass),ak.Array([[None]]),lep_mass)              
...
#              cutmet_mtw=met_pt+mtw>70  #For adding cut in sum of MET and Mw (me)
 #             cutmet_mtw=ak.fill_none(cutmet_mtw,False)
              ...
              if ch in ['e_plus','e_minus']: mlb=GetMlb1b(e0,b0)
              if ch in ['m_plus','m_minus']: mlb=GetMlb1b(m0,b0)
              if ch in ['e_fake_plus','e_fake_minus']: mlb=GetMlb1b(e_fake0,b0)
              if ch in ['m_fake_plus','m_fake_minus']: mlb=GetMlb1b(m_fake0,b0)
...
########################################################################################################                   Up to here the cut thing
              ...
              #print('channel',ch,'level',lev,'cut',sum(cut))
              #print(ch,lev,sum(cut))
...
#####################################       Time to do the W-boson recosntruction (not to raise problems in the minimization first we have to apply the cut) 		###################################
              ...
              if ch in ['e_plus','m_plus','e_minus','m_minus']:
...
######################################  Redefine cuts from here if wanting to add something on the w-top system ##############################################################
              ...
              weights = weights_dict[ch if not 'fake' in ch else ch[:1]+ch[6:]].weight(syst if not syst in (['norm']+systJets) else None)
              ...
              for cat in jetcategories:
               ...
               if fillAcc and not isData and syst=='norm' and ch in ['e_plus', 'm_plus','e_minus','m_minus'] and lev in ['2j1b']:
               ...
               lep =  m_sel_plus if ch == 'm_plus' else m_fake_plus if ch == 'm_fake_plus' else m_sel_minus if ch == 'm_minus' else m_fake_minus if ch== 'm_fake_minus' else  e_sel_plus if ch == 'e_plus' else e_fake_plus if ch == 'e_fake_plus' else e_sel_minus if ch == 'e_minus' else e_fake_minus
               
               
               lpt=lep_pt
               leta=lep_eta
               lpt=ak.flatten(lpt)
               leta=ak.flatten(leta)
               lpt=ak.fill_none(lpt,False)
               leta=ak.fill_none(leta,False)       
               lowpt=(lpt<80) 
               highpt=(lpt>=80)
               loweta=(abs(leta)<0.8) 
               higheta=(abs(leta)>=0.8) 

               
               cut_loweta_lowpt=(loweta)&(lowpt) & (cut)
               cut_loweta_highpt=(loweta)&(highpt) & (cut)
               cut_higheta_lowpt=(higheta)&(lowpt) & (cut)
               cut_higheta_highpt=(higheta)&(highpt) & (cut)
               
               
               cut_ll_truncated_0=(loweta)&(lowpt)
               cut_ll_truncated=cut_ll_truncated_0[cut]
               cut_lh_truncated_0=(loweta)&(highpt)
               cut_lh_truncated=cut_lh_truncated_0[cut]
               cut_hl_truncated_0=(higheta)&(lowpt)
               cut_hl_truncated=cut_hl_truncated_0[cut]
               cut_hh_truncated_0=(higheta)&(highpt)
               cut_hh_truncated=cut_hh_truncated_0[cut]
             ...
             #  hout['mtwnocut'].fill(sample=histAxisName, channel=ch, level=lev, mtwnocut=mtw[cutnomet], syst=syst, weight=weights[cutnomet])
               ...
               weights_frshape = weights
               weights_frshape_cut = weights_frshape[cut]
               
               weights_ll=weights_frshape[cut_loweta_lowpt]
               weights_lh=weights_frshape[cut_loweta_highpt]
               weights_hl=weights_frshape[cut_higheta_lowpt]
               weights_hh=weights_frshape[cut_higheta_highpt]
  ...
  ### addded             
               ...
               if ak.any(Detalu[cut] == None):print("None values found in Detalu[cut]");print()
               
               if lev in ['2j1b','3j1b','3j2b']:hout['mub'].fill(sample=histAxisName, channel=ch, level=lev, mub=mub[cut], syst=syst, weight=weights)
               #if lev in ['2j1b','3j1b','3j2b']:hout['Detalu'].fill(sample=histAxisName, channel=ch, level=lev, Detalu=Detalu[cut], syst=syst, weight=weights)
           ...
           #    hout['DRlu'].fill(sample=histAxisName, channel=ch, level=lev, DRlu=DRlu[cut], syst=syst, weight=weights)
               ...
               if lev in ['2j1b','3j1b','3j2b']:hout['u0eta'].fill(sample=histAxisName, channel=ch, level=lev, u0eta=u0eta[cut], syst=syst, weight=weights)
               if lev in ['2j1b','3j1b','3j2b']:hout['absu0eta'].fill(sample=histAxisName, channel=ch, level=lev, absu0eta=abs(u0eta)[cut], syst=syst, weight=weights)              
               if lev in ['2j1b','3j1b','3j2b']:hout['u0pt'].fill(sample=histAxisName, channel=ch, level=lev, u0pt=u0pt[cut], syst=syst, weight=weights)
               ...
               if lev in ['2j1b','3j1b','3j2b']:hout['u0mass'].fill(sample=histAxisName, channel=ch, level=lev, u0mass=u0mass[cut], syst=syst, weight=weights) 
 ...
 ###
               ...
               if fillAll:
                 if lev != 'incl' and '0b' not in lev: # Fill jet related variables when there is at least one jet
                   ...
                   hout['j0pt_ll'].fill(sample=histAxisName, channel=ch, level=lev, j0pt_ll=fj0ptbis[cut_loweta_lowpt], syst=syst, weight=weights_frshape[cut_loweta_lowpt])
                   hout['j0pt_lh'].fill(sample=histAxisName, channel=ch, level=lev, j0pt_lh=fj0ptbis[cut_loweta_highpt], syst=syst, weight=weights_frshape[cut_loweta_highpt])
                   hout['j0pt_hl'].fill(sample=histAxisName, channel=ch, level=lev, j0pt_hl=fj0ptbis[cut_higheta_lowpt], syst=syst, weight=weights_frshape[cut_higheta_lowpt])
                   hout['j0pt_hh'].fill(sample=histAxisName, channel=ch, level=lev, j0pt_hh=fj0ptbis[cut_higheta_highpt], syst=syst, weight=weights_frshape[cut_higheta_highpt])
                 ...
                 if ch in ['e_plus','e_minus', 'e_fake_plus','e_fake_minus']:
                   e =  e_sel_plus if ch == 'e_plus' else e_fake_plus if ch == 'e_fake_plus' else e_sel_minus if ch == 'e_minus' else e_fake_minus
                   lpt  = ak.flatten(e.pt [cut])
                   leta = ak.flatten(e.eta[cut])
                   mt = ak.flatten(GetMT(e, met)[cut])
                   if len(lpt)!=sum(cut):                                   #print(ch,'antes',len(weights),type(weights)) 
                      if ch == 'e_fake_minus': recorte=(e_pdgId_new[cut])>0;weights_copy=np.copy(weights);weights=weights[recorte];#print('despues',len(weights));
                      if ch == 'e_fake_plus': recorte=(e_pdgId_new[cut])<0;weights_copy=np.copy(weights);weights=weights[recorte];#print('despues',len(weights));             

                      if ch == 'e_fake_minus': recorte_ll=(e_pdgId_new[cut_loweta_lowpt])>0;weights_copy_ll=np.copy(weights_frshape_cut);weights_ll=weights_frshape_cut[recorte_ll];
                      if ch == 'e_fake_plus': recorte_ll=(e_pdgId_new[cut_loweta_lowpt])<0;weights_copy_ll=np.copy(weights_frshape_cut);weights_ll=weights_frshape_cut[recorte_ll];
                      if ch == 'e_fake_minus': recorte_lh=(e_pdgId_new[cut_loweta_highpt])>0;weights_copy_lh=np.copy(weights_frshape_cut);weights_lh=weights_frshape_cut[recorte_lh];
                      if ch == 'e_fake_plus': recorte_lh=(e_pdgId_new[cut_loweta_highpt])<0;weights_copy_lh=np.copy(weights_frshape_cut);weights_lh=weights_frshape_cut[recorte_lh];
                      if ch == 'e_fake_minus': recorte_hl=(e_pdgId_new[cut_higheta_lowpt])>0;weights_copy_hl=np.copy(weights_frshape_cut);weights_hl=weights_frshape_cut[recorte_hl];
                      if ch == 'e_fake_plus': recorte_hl=(e_pdgId_new[cut_higheta_lowpt])<0;weights_copy_hl=np.copy(weights_frshape_cut);weights_hl=weights_frshape_cut[recorte_hl];
                      if ch == 'e_fake_minus': recorte_hh=(e_pdgId_new[cut_higheta_highpt])>0;weights_copy_hh=np.copy(weights_frshape_cut);weights_hh=weights_frshape_cut[recorte_hh];
                      if ch == 'e_fake_plus': recorte_hh=(e_pdgId_new[cut_higheta_highpt])<0;weights_copy_hh=np.copy(weights_frshape_cut);weights_hh=weights_frshape_cut[recorte_hh];


                   MVAtth = ak.flatten(e.mvaTTH[cut])
                   MVAwp = ak.flatten(e.mvaFall17V2noIso_WPL[cut])#mvaFall17V2noIso_WPL
...
#                   if lev in ['2j1b','3j1b','3j2b']:hout['coste_3'].fill(sample=histAxisName, channel=ch, level=lev, coste_3=cos2_abs[cut], syst=syst, weight=weights)
 ...
 #                     hout['mlb'].fill(sample=histAxisName, channel=ch, level=lev, mlb=mlb, syst=syst, weight=weights)
                      if fillMVA and lev in ['2j1b','3j1b','3j2b'] and self.model_2j1b is not None and len(fht) > 0:
                        ...
                        if len(lpt)!=sum(cut):varsb10 = [abs(u0eta)[cut][recorte],abs(b0eta-u0eta)[cut][recorte],invariant_masses[cut][recorte],mt,fdrjjmed[recorte],mlb[cut][recorte],fmjj[recorte],mub[cut][recorte],fptSumVecAll[recorte],ht_atlas[cut][recorte],DptWub[cut][recorte],DphiWub[cut][recorte],Detalu[cut][recorte]];# print('variables',*np.column_stack(varsb10));print()
                        


                        #MVAscore_nom_pruned = self.model_pruned.predict_proba(np.column_stack(vars2j1b))[:,1] # asipara 2 clases
                        variables=np.column_stack(varsb10)
                        if ak.count(variables)>0:MVAscore_nom_relaxed_b10 = self.model_relaxed_b10.predict_proba(variables)[:,1];
                     
                        #if len(lpt)!=sum(cut):print('variable',len(MVAscore_nom_relaxed_b10),*MVAscore_nom_relaxed_b10,'\n weghts',len(weights));print()
                        hout['MVAscore_relaxed_b10'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10=MVAscore_nom_relaxed_b10, syst=syst, weight=weights) if len(MVAscore_nom_relaxed_b10)==len(weights) else hout['MVAscore_relaxed_b10'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10=MVAscore_nom_relaxed_b10, syst=syst, weight=weights_copy)



                        
                        varsb10_ll = [abs(u0eta)[cut_loweta_lowpt],abs(b0eta-u0eta)[cut_loweta_lowpt],invariant_masses[cut_loweta_lowpt],mt[cut_ll_truncated],fdrjjmed[cut_ll_truncated],mlb[cut_loweta_lowpt],fmjj[cut_ll_truncated],mub[cut_loweta_lowpt],fptSumVecAll[cut_ll_truncated],ht_atlas[cut_loweta_lowpt],DptWub[cut_loweta_lowpt],DphiWub[cut_loweta_lowpt],Detalu[cut_loweta_lowpt]]
                        if len(lpt)!=sum(cut):varsb10_ll = [abs(u0eta)[cut_loweta_lowpt][recorte_ll],abs(b0eta-u0eta)[cut_loweta_lowpt][recorte_ll],invariant_masses[cut_loweta_lowpt][recorte_ll],mt[cut_ll_truncated],fdrjjmed[cut_ll_truncated][recorte_ll],mlb[cut_loweta_lowpt][recorte_ll],fmjj[cut_ll_truncated][recorte_ll],mub[cut_loweta_lowpt][recorte_ll],fptSumVecAll[cut_ll_truncated][recorte_ll],ht_atlas[cut_loweta_lowpt][recorte_ll],DptWub[cut_loweta_lowpt][recorte_ll],DphiWub[cut_loweta_lowpt][recorte_ll],Detalu[cut_loweta_lowpt][recorte_ll]];# print('variables',*np.column_stack(varsb10));print()
                        variables_ll=np.column_stack(varsb10_ll)
                        print('chan',ch,'levl',lev,'\n variables_ll electron',variables_ll)
                        if ak.count(variables_ll)>0:MVAscore_nom_relaxed_b10_ll = self.model_relaxed_b10.predict_proba(variables_ll)[:,1];
                        if ak.count(variables_ll)==0: continue
                        hout['MVAscore_relaxed_b10_ll'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_ll=MVAscore_nom_relaxed_b10_ll, syst=syst, weight=weights_ll) if len(MVAscore_nom_relaxed_b10_ll)==len(weights_ll) else hout['MVAscore_relaxed_b10_ll'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_ll=MVAscore_nom_relaxed_b10_ll, syst=syst, weight=weights_copy_ll)
                        
                        varsb10_lh = [abs(u0eta)[cut_loweta_highpt],abs(b0eta-u0eta)[cut_loweta_highpt],invariant_masses[cut_loweta_highpt],mt[cut_lh_truncated],fdrjjmed[cut_lh_truncated],mlb[cut_loweta_highpt],fmjj[cut_lh_truncated],mub[cut_loweta_highpt],fptSumVecAll[cut_lh_truncated],ht_atlas[cut_loweta_highpt],DptWub[cut_loweta_highpt],DphiWub[cut_loweta_highpt],Detalu[cut_loweta_highpt]]
                        if len(lpt)!=sum(cut):varsb10_lh = [abs(u0eta)[cut_loweta_highpt][recorte_lh],abs(b0eta-u0eta)[cut_loweta_highpt][recorte_lh],invariant_masses[cut_loweta_highpt][recorte_lh],mt[cut_lh_truncated],fdrjjmed[cut_lh_truncated][recorte_lh],mlb[cut_loweta_highpt][recorte_lh],fmjj[cut_lh_truncated][recorte_lh],mub[cut_loweta_highpt][recorte_lh],fptSumVecAll[cut_lh_truncated][recorte_lh],ht_atlas[cut_loweta_highpt][recorte_lh],DptWub[cut_loweta_highpt][recorte_lh],DphiWub[cut_loweta_highpt][recorte_lh],Detalu[cut_loweta_highpt][recorte_lh]];# print('variables',*np.column_stack(varsb10));print()
                        variables_lh=np.column_stack(varsb10_lh)
                        if ak.count(variables_lh)>0:MVAscore_nom_relaxed_b10_lh = self.model_relaxed_b10.predict_proba(variables_lh)[:,1];
                        if ak.count(variables_lh)==0: continue
                        hout['MVAscore_relaxed_b10_lh'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_lh=MVAscore_nom_relaxed_b10_lh, syst=syst, weight=weights_lh) if len(MVAscore_nom_relaxed_b10_lh)==len(weights_lh) else hout['MVAscore_relaxed_b10_lh'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_lh=MVAscore_nom_relaxed_b10_lh, syst=syst, weight=weights_copy_lh)
                        
                                               
                        varsb10_hl = [abs(u0eta)[cut_higheta_lowpt],abs(b0eta-u0eta)[cut_higheta_lowpt],invariant_masses[cut_higheta_lowpt],mt[cut_hl_truncated],fdrjjmed[cut_hl_truncated],mlb[cut_higheta_lowpt],fmjj[cut_hl_truncated],mub[cut_higheta_lowpt],fptSumVecAll[cut_hl_truncated],ht_atlas[cut_higheta_lowpt],DptWub[cut_higheta_lowpt],DphiWub[cut_higheta_lowpt],Detalu[cut_higheta_lowpt]]
                        if len(lpt)!=sum(cut):varsb10_hl = [abs(u0eta)[cut_higheta_lowpt][recorte_hl],abs(b0eta-u0eta)[cut_higheta_lowpt][recorte_hl],invariant_masses[cut_higheta_lowpt][recorte_hl],mt[cut_hl_truncated],fdrjjmed[cut_hl_truncated][recorte_hl],mlb[cut_higheta_lowpt][recorte_hl],fmjj[cut_hl_truncated][recorte_hl],mub[cut_higheta_lowpt][recorte_hl],fptSumVecAll[cut_hl_truncated][recorte_hl],ht_atlas[cut_higheta_lowpt][recorte_hl],DptWub[cut_higheta_lowpt][recorte_hl],DphiWub[cut_higheta_lowpt][recorte_hl],Detalu[cut_higheta_lowpt][recorte_hl]];# print('variables',*np.column_stack(varsb10));print()
                        variables_hl=np.column_stack(varsb10_hl)
                        if ak.count(variables_hl)>0:MVAscore_nom_relaxed_b10_hl = self.model_relaxed_b10.predict_proba(variables_hl)[:,1];
                        if ak.count(variables_hl)==0: continue
                        hout['MVAscore_relaxed_b10_hl'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_hl=MVAscore_nom_relaxed_b10_hl, syst=syst, weight=weights_hl) if len(MVAscore_nom_relaxed_b10_hl)==len(weights_hl) else hout['MVAscore_relaxed_b10_hl'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_hl=MVAscore_nom_relaxed_b10_hl, syst=syst, weight=weights_copy_hl)
                        
                                               
                        varsb10_hh = [abs(u0eta)[cut_higheta_highpt],abs(b0eta-u0eta)[cut_higheta_highpt],invariant_masses[cut_higheta_highpt],mt[cut_hh_truncated],fdrjjmed[cut_hh_truncated],mlb[cut_higheta_highpt],fmjj[cut_hh_truncated],mub[cut_higheta_highpt],fptSumVecAll[cut_hh_truncated],ht_atlas[cut_higheta_highpt],DptWub[cut_higheta_highpt],DphiWub[cut_higheta_highpt],Detalu[cut_higheta_highpt]]
                        if len(lpt)!=sum(cut):varsb10_hh = [abs(u0eta)[cut_higheta_highpt][recorte_hh],abs(b0eta-u0eta)[cut_higheta_highpt][recorte_hh],invariant_masses[cut_higheta_highpt][recorte_hh],mt[cut_hh_truncated],fdrjjmed[cut_hh_truncated][recorte_hh],mlb[cut_higheta_highpt][recorte_hh],fmjj[cut_hh_truncated][recorte_hh],mub[cut_higheta_highpt][recorte_hh],fptSumVecAll[cut_hh_truncated][recorte_hh],ht_atlas[cut_higheta_highpt][recorte_hh],DptWub[cut_higheta_highpt][recorte_hh],DphiWub[cut_higheta_highpt][recorte_hh],Detalu[cut_higheta_highpt][recorte_hh]];# print('variables',*np.column_stack(varsb10));print()
                        variables_hh=np.column_stack(varsb10_hh)
                        if ak.count(variables_hh)>0:MVAscore_nom_relaxed_b10_hh = self.model_relaxed_b10.predict_proba(variables_hh)[:,1];
                        if ak.count(variables_hh)==0: continue
                        hout['MVAscore_relaxed_b10_hh'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_hh=MVAscore_nom_relaxed_b10_hh, syst=syst, weight=weights_hh) if len(MVAscore_nom_relaxed_b10_hh)==len(weights_hh) else hout['MVAscore_relaxed_b10_hh'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_hh=MVAscore_nom_relaxed_b10_hh, syst=syst, weight=weights_copy_hh)     




                 elif ch in ['m_plus', 'm_fake_plus','m_minus','m_fake_minus']:
                   #m = m_sel if ch == 'm' else m_fake
                   m =  m_sel_plus if ch == 'm_plus' else m_fake_plus if ch == 'm_fake_plus' else m_sel_minus if ch == 'm_minus' else m_fake_minus
                   lpt  = ak.flatten(m.pt[cut])
                   
                   #if len(lpt)!=sum(cut): print('LONGITUDES',len(lpt),sum(cut),'\n vectores',lpt,'\n m',m[cut],'\n aknumcut',ak.num(m_fake_minus)[cut],'\n plus',ak.num(m_fake_plus)[cut],'\n pdg',*m_pdgId_new[cut],'\n event');print(ch,m.pt[cut],'\n',lpt,'\n',m.pt);print();exit()
                   #if len(lpt)!=sum(cut): print(len(m_pdgId_new[cut]),m_pdgId_new[cut],'\n lpt',len(lpt),*lpt);print()
                   leta = ak.flatten(m.eta[cut])
                   mt = ak.flatten(GetMT(m, met)[cut])
                   if len(lpt)!=sum(cut):
                      if ch == 'm_fake_minus': recorte=(m_pdgId_new[cut])>0;weights=weights[recorte];#lpt=lpt[recorte];mt=mt[recorte];leta=leta[recorte];
                      if ch == 'm_fake_plus': recorte=(m_pdgId_new[cut])<0;weights=weights[recorte];#lpt=lpt[recorte];mt=mt[recorte];leta=leta[recorte]
                      
                      if ch == 'm_fake_minus': recorte_ll=(m_pdgId_new[cut_loweta_lowpt])>0;weights_ll=weights_ll[recorte_ll];# weights_ll=weights_frshape_cut[recorte_ll]; 
                      if ch == 'm_fake_plus': recorte_ll=(m_pdgId_new[cut_loweta_lowpt])<0;weights_ll=weights_ll[recorte_ll];#weights_ll=weights_frshape_cut[recorte_ll];
                      if ch == 'm_fake_minus': recorte_lh=(m_pdgId_new[cut_loweta_highpt])>0;weights_lh=weights_lh[recorte_lh];#weights_lh=weights_frshape_cut[recorte_lh];
                      if ch == 'm_fake_plus': recorte_lh=(m_pdgId_new[cut_loweta_highpt])<0;weights_lh=weights_lh[recorte_lh];#weights_lh=weights_frshape_cut[recorte_lh];
                      if ch == 'm_fake_minus': recorte_hl=(m_pdgId_new[cut_higheta_lowpt])>0;weights_hl=weights_hl[recorte_hl];#weights_hl=weights_frshape_cut[recorte_hl];
                      if ch == 'm_fake_plus': recorte_hl=(m_pdgId_new[cut_higheta_lowpt])<0;weights_hl=weights_hl[recorte_hl];#weights_hl=weights_frshape_cut[recorte_hl];
                      if ch == 'm_fake_minus': recorte_hh=(m_pdgId_new[cut_higheta_highpt])>0;weights_hh=weights_hh[recorte_hh];#weights_hh=weights_frshape_cut[recorte_hh];
                      if ch == 'm_fake_plus': recorte_hh=(m_pdgId_new[cut_higheta_highpt])<0;weights_hh=weights_hh[recorte_hh];#weights_hh=weights_frshape_cut[recorte_hh];
...
#                   if lev in ['2j1b','3j1b','3j2b']:hout['costm_3'].fill(sample=histAxisName, channel=ch, level=lev, costm_3=cos2_abs[cut], syst=syst, weight=weights)
 ...
 #                     hout['mlb'].fill(sample=histAxisName, channel=ch, level=lev, mlb=mlb, syst=syst, weight=weights)
                      ...
                      if fillMVA and lev in ['2j1b','3j1b','3j2b'] and self.model_2j1b is not None and len(fht) > 0:
                        ...
                        variables=np.column_stack(varsb10)
                        MVAscore_nom_relaxed_b10 = self.model_relaxed_b10.predict_proba(np.where(np.isnan(variables),-99,variables))[:,1]
                        ...
                        #print('len mt',len(mt),'len fdrjjmed',len(fdrjjmed),'len fmjj',len(fmjj),'len fptSumVecAll',len(fptSumVecAll),'\n len cut truncated',len(cut_ll_truncated))
                        #print()
                        if len(lpt)==sum(cut):varsb10_ll = [abs(u0eta)[cut_loweta_lowpt],abs(b0eta-u0eta)[cut_loweta_lowpt],invariant_masses[cut_loweta_lowpt],mt[cut_ll_truncated],fdrjjmed[cut_ll_truncated],mlb[cut_loweta_lowpt],fmjj[cut_ll_truncated],mub[cut_loweta_lowpt],fptSumVecAll[cut_ll_truncated],ht_atlas[cut_loweta_lowpt],DptWub[cut_loweta_lowpt],DphiWub[cut_loweta_lowpt],Detalu[cut_loweta_lowpt]]
                        else: diff=len(fmjj)-len(mt);cut_ll_truncated_mt=cut_ll_truncated[:-diff];varsb10_ll = [abs(u0eta)[cut_loweta_lowpt][recorte_ll],abs(b0eta-u0eta)[cut_loweta_lowpt][recorte_ll],invariant_masses[cut_loweta_lowpt][recorte_ll],mt[cut_ll_truncated],fdrjjmed[cut_ll_truncated][recorte_ll],mlb[cut_loweta_lowpt][recorte_ll],fmjj[cut_ll_truncated][recorte_ll],mub[cut_loweta_lowpt][recorte_ll],fptSumVecAll[cut_ll_truncated][recorte_ll],ht_atlas[cut_loweta_lowpt][recorte_ll],DptWub[cut_loweta_lowpt][recorte_ll],DphiWub[cut_loweta_lowpt][recorte_ll],Detalu[cut_loweta_lowpt][recorte_ll]];# print('variables',*np.column_stack(varsb10));print()
                        variables_ll=np.column_stack(varsb10_ll)
                       # print('chan',ch,'levl',lev,'\n variables_ll muon',variables_ll,'size',ak.to_numpy(variables_ll).shape)
                       # print()
                       # print('hola')                        
                        if ak.to_numpy(variables_ll).shape[0]<1: continue
                        MVAscore_nom_relaxed_b10_ll = self.model_relaxed_b10.predict_proba(np.where(np.isnan(variables_ll),-99,variables_ll))[:,1]
                        hout['MVAscore_relaxed_b10_ll'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_ll=MVAscore_nom_relaxed_b10_ll, syst=syst, weight=weights_ll)

                        varsb10_lh = [abs(u0eta)[cut_loweta_highpt],abs(b0eta-u0eta)[cut_loweta_highpt],invariant_masses[cut_loweta_highpt],mt[cut_lh_truncated],fdrjjmed[cut_lh_truncated],mlb[cut_loweta_highpt],fmjj[cut_lh_truncated],mub[cut_loweta_highpt],fptSumVecAll[cut_lh_truncated],ht_atlas[cut_loweta_highpt],DptWub[cut_loweta_highpt],DphiWub[cut_loweta_highpt],Detalu[cut_loweta_highpt]]
                        if len(lpt)!=sum(cut):varsb10_lh = [abs(u0eta)[cut_loweta_highpt][recorte_lh],abs(b0eta-u0eta)[cut_loweta_highpt][recorte_lh],invariant_masses[cut_loweta_highpt][recorte_lh],mt[cut_lh_truncated],fdrjjmed[cut_lh_truncated][recorte_lh],mlb[cut_loweta_highpt][recorte_lh],fmjj[cut_lh_truncated][recorte_lh],mub[cut_loweta_highpt][recorte_lh],fptSumVecAll[cut_lh_truncated][recorte_lh],ht_atlas[cut_loweta_highpt][recorte_lh],DptWub[cut_loweta_highpt][recorte_lh],DphiWub[cut_loweta_highpt][recorte_lh],Detalu[cut_loweta_highpt][recorte_lh]];# print('variables',*np.column_stack(varsb10));print()
                        variables_lh=np.column_stack(varsb10_lh)
                        if ak.to_numpy(variables_lh).shape[0]<1: continue
                        MVAscore_nom_relaxed_b10_lh = self.model_relaxed_b10.predict_proba(np.where(np.isnan(variables_lh),-99,variables_lh))[:,1]
                        hout['MVAscore_relaxed_b10_lh'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_lh=MVAscore_nom_relaxed_b10_lh, syst=syst, weight=weights_lh)

                        varsb10_hl = [abs(u0eta)[cut_higheta_lowpt],abs(b0eta-u0eta)[cut_higheta_lowpt],invariant_masses[cut_higheta_lowpt],mt[cut_hl_truncated],fdrjjmed[cut_hl_truncated],mlb[cut_higheta_lowpt],fmjj[cut_hl_truncated],mub[cut_higheta_lowpt],fptSumVecAll[cut_hl_truncated],ht_atlas[cut_higheta_lowpt],DptWub[cut_higheta_lowpt],DphiWub[cut_higheta_lowpt],Detalu[cut_higheta_lowpt]]
                        if len(lpt)!=sum(cut):varsb10_hl = [abs(u0eta)[cut_higheta_lowpt][recorte_hl],abs(b0eta-u0eta)[cut_higheta_lowpt][recorte_hl],invariant_masses[cut_higheta_lowpt][recorte_hl],mt[cut_hl_truncated],fdrjjmed[cut_hl_truncated][recorte_hl],mlb[cut_higheta_lowpt][recorte_hl],fmjj[cut_hl_truncated][recorte_hl],mub[cut_higheta_lowpt][recorte_hl],fptSumVecAll[cut_hl_truncated][recorte_hl],ht_atlas[cut_higheta_lowpt][recorte_hl],DptWub[cut_higheta_lowpt][recorte_hl],DphiWub[cut_higheta_lowpt][recorte_hl],Detalu[cut_higheta_lowpt][recorte_hl]];# print('variables',*np.column_stack(varsb10));print()
                        variables_hl=np.column_stack(varsb10_hl)
                        if ak.to_numpy(variables_hl).shape[0]<1: continue
                        MVAscore_nom_relaxed_b10_hl = self.model_relaxed_b10.predict_proba(np.where(np.isnan(variables_hl),-99,variables_hl))[:,1]
                        hout['MVAscore_relaxed_b10_hl'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_hl=MVAscore_nom_relaxed_b10_hl, syst=syst, weight=weights_hl)

                        varsb10_hh = [abs(u0eta)[cut_higheta_highpt],abs(b0eta-u0eta)[cut_higheta_highpt],invariant_masses[cut_higheta_highpt],mt[cut_hh_truncated],fdrjjmed[cut_hh_truncated],mlb[cut_higheta_highpt],fmjj[cut_hh_truncated],mub[cut_higheta_highpt],fptSumVecAll[cut_hh_truncated],ht_atlas[cut_higheta_highpt],DptWub[cut_higheta_highpt],DphiWub[cut_higheta_highpt],Detalu[cut_higheta_highpt]]
                        if len(lpt)!=sum(cut):varsb10_hh = [abs(u0eta)[cut_higheta_highpt][recorte_hh],abs(b0eta-u0eta)[cut_higheta_highpt][recorte_hh],invariant_masses[cut_higheta_highpt][recorte_hh],mt[cut_hh_truncated],fdrjjmed[cut_hh_truncated][recorte_hh],mlb[cut_higheta_highpt][recorte_hh],fmjj[cut_hh_truncated][recorte_hh],mub[cut_higheta_highpt][recorte_hh],fptSumVecAll[cut_hh_truncated][recorte_hh],ht_atlas[cut_higheta_highpt][recorte_hh],DptWub[cut_higheta_highpt][recorte_hh],DphiWub[cut_higheta_highpt][recorte_hh],Detalu[cut_higheta_highpt][recorte_hh]];# print('variables',*np.column_stack(varsb10));print()
                        variables_hh=np.column_stack(varsb10_hh)
                        if ak.to_numpy(variables_hh).shape[0]<1: continue
                        MVAscore_nom_relaxed_b10_hh = self.model_relaxed_b10.predict_proba(np.where(np.isnan(variables_hh),-99,variables_hh))[:,1]
                        hout['MVAscore_relaxed_b10_hh'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_hh=MVAscore_nom_relaxed_b10_hh, syst=syst, weight=weights_hh)                      
