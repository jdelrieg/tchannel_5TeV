...
class AnalysisProcessor(processor.ProcessorABC):
    def __init__(self, samples, model):
        ...
        'metnocut'   : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("metnocut",     "MET (GeV)", 45, 0, 150)),
...
########################################################################################################                   Up to here the cut thing
              ...
              cutnomet = (cutsel) & (cutjetsnomet) & (cutbeta) & (cutueta) & (cutdeltaeta) & (cutmtw)  & (cutht)& (cutmlb) #   & (cutmet_mtw)
              ...
              cut_metg30 = (cutnomet) & GetCutJets(['metg30'], syst, met_pt, njets_var, nbtags_var)   # de aqui   para looser 2 tengo 25 20 15
              ...
              cut_metl15 = (cutnomet) & GetCutJets(['metl15'], syst, met_pt, njets_var, nbtags_var)   # a aqui  mtw-> met_pt si queremos hacer el calculo de qcd con met y no mtw
