...
########################################################################################################                   Up to here the cut thing
              ...
              cut = (cutsel) & (cutjets) & (cutmtw) & (cutmlb) & (cutht)
              ...
              cutnomet = (cutsel) & (cutjetsnomet)  & (cutmtw) & (cutmlb) & (cutht)
...
#              if ch in ['e_fake','m_fake']:
 ...
 ### addded             
              ...
              hout['b0pt'].fill(sample=histAxisName, channel=ch, level=lev, b0pt=b0pt[cut], syst=syst, weight=weights)                  
              ...
              hout['topmass'].fill(sample=histAxisName, channel=ch, level=lev, topmass=invariant_masses[cut], syst=syst, weight=weights)          
              
              hout['u0mass'].fill(sample=histAxisName, channel=ch, level=lev, u0mass=u0mass[cut], syst=syst, weight=weights) 
              hout['drub'].fill(sample=histAxisName, channel=ch, level=lev, drub=dRub[cut], syst=syst, weight=weights) 
              hout['absweta'].fill(sample=histAxisName, channel=ch, level=lev, absweta=w_etas[cut], syst=syst, weight=weights)
              hout['topeta'].fill(sample=histAxisName, channel=ch, level=lev, topeta=top_eta[cut], syst=syst, weight=weights)        
###
              ...
              if fillAll:
                ...
                if ch in ['e', 'e_fake']:
                  ...
                  hout['coste'].fill(sample=histAxisName, channel=ch, level=lev, coste=cost[cut], syst=syst, weight=weights)
                  hout['coste_top'].fill(sample=histAxisName, channel=ch, level=lev, coste_top=cost_top[cut], syst=syst, weight=weights)
                  
                  hout['coste_1'].fill(sample=histAxisName, channel=ch, level=lev, coste_1=cos1[cut], syst=syst, weight=weights)
                  hout['coste_2'].fill(sample=histAxisName, channel=ch, level=lev, coste_2=cos2[cut], syst=syst, weight=weights)
                  hout['coste_3'].fill(sample=histAxisName, channel=ch, level=lev, coste_3=cos2_abs[cut], syst=syst, weight=weights)
...
#                     hout['mlb'].fill(sample=histAxisName, channel=ch, level=lev, mlb=mlb, syst=syst, weight=weights)
                     if fillMVA and lev in ['2j1b','3j1b','3j2b'] and self.model_2j1b is not None and len(fht) > 0:
                       ...
                       #MVAscore_nom_2j1b = self.model_2j1b.predict_proba(np.column_stack(vars2j1b))[:,0]  #asi para 3 clases
                       hout['MVAscore'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore=MVAscore_nom_2j1b, syst=syst, weight=weights)
                       hout['MVAscore_binned'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_binned=MVAscore_nom_2j1b, syst=syst, weight=weights)
                  ...
                  hout['costm'].fill(sample=histAxisName, channel=ch, level=lev, costm=cost[cut], syst=syst, weight=weights)
                  hout['costm_top'].fill(sample=histAxisName, channel=ch, level=lev, costm_top=cost_top[cut], syst=syst, weight=weights)
                  
                  hout['costm_1'].fill(sample=histAxisName, channel=ch, level=lev, costm_1=cos1[cut], syst=syst, weight=weights)
                  hout['costm_2'].fill(sample=histAxisName, channel=ch, level=lev, costm_2=cos2[cut], syst=syst, weight=weights)
                  hout['costm_3'].fill(sample=histAxisName, channel=ch, level=lev, costm_3=cos2_abs[cut], syst=syst, weight=weights)
