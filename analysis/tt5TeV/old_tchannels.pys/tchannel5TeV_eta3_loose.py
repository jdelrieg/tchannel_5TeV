...
class AnalysisProcessor(processor.ProcessorABC):
    ...
    def __init__(self, samples, model):
        ...
        if isinstance(model, list) and len(model) >= 2:
          ...
          self.model_all = model[0]
          self.model_pruned = model[1]
          self.model_b6 = model[2]
          self.model_b10 = model[3]
          
          self.model_tX = model[4]
          self.model_relaxed_b10 = model[5]
        ...
        'MVAscore_pruned_cut'     : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("MVAscore_pruned_cut", "MVA score", 10,0.5,1 )),
        'MVAscore_relaxed_b10_cut'     : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("MVAscore_relaxed_b10_cut", "MVA score", 10,0.5,1 )),
...
#QCD ex        
#        'counts_metl29': hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("counts",  "Counts", 1, 0, 10)),
#        'counts_metl28': hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("counts",  "Counts", 1, 0, 10)),
#        'counts_metl27': hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("counts",  "Counts", 1, 0, 10)),
#        'counts_metl26': hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("counts",  "Counts", 1, 0, 10)),
#        'counts_metl24': hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("counts",  "Counts", 1, 0, 10)),
#        'counts_metl23': hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("counts",  "Counts", 1, 0, 10)),
#        'counts_metl22': hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("counts",  "Counts", 1, 0, 10)),
#        'counts_metl21': hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("counts",  "Counts", 1, 0, 10)),
# fin qcd ex        
...
### ejercicio QCD
#               cut_metl24 = (cutnomet) & GetCutJets(['metl24'], syst, met_pt, njets_var, nbtags_var)     
#               cut_metl23 = (cutnomet) & GetCutJets(['metl23'], syst, met_pt, njets_var, nbtags_var)     
#               cut_metl22 = (cutnomet) & GetCutJets(['metl22'], syst, met_pt, njets_var, nbtags_var)     
#               cut_metl21 = (cutnomet) & GetCutJets(['metl21'], syst, met_pt, njets_var, nbtags_var)     
#               cut_metl29 = (cutnomet) & GetCutJets(['metl29'], syst, met_pt, njets_var, nbtags_var)     
#               cut_metl28 = (cutnomet) & GetCutJets(['metl28'], syst, met_pt, njets_var, nbtags_var)     
#               cut_metl27 = (cutnomet) & GetCutJets(['metl27'], syst, met_pt, njets_var, nbtags_var)     
#               cut_metl26 = (cutnomet) & GetCutJets(['metl26'], syst, met_pt, njets_var, nbtags_var)    
#               weights_metl24 = weights[cut_metl24]; weights_metl23 = weights[cut_metl23]
#               weights_metl22 = weights[cut_metl22]; weights_metl21 = weights[cut_metl21]
#               weights_metl29 = weights[cut_metl29]; weights_metl28 = weights[cut_metl28]
#               weights_metl27 = weights[cut_metl27]; weights_metl26 = weights[cut_metl26]  
#               hout['counts_metl24'].fill(sample=histAxisName, channel=ch, level=lev, counts=counts[cut_metl24], syst=syst, weight=weights_metl24)
#               hout['counts_metl23'].fill(sample=histAxisName, channel=ch, level=lev, counts=counts[cut_metl23], syst=syst, weight=weights_metl23)
#               hout['counts_metl22'].fill(sample=histAxisName, channel=ch, level=lev, counts=counts[cut_metl22], syst=syst, weight=weights_metl22)
#               hout['counts_metl21'].fill(sample=histAxisName, channel=ch, level=lev, counts=counts[cut_metl21], syst=syst, weight=weights_metl21)
#               hout['counts_metl29'].fill(sample=histAxisName, channel=ch, level=lev, counts=counts[cut_metl29], syst=syst, weight=weights_metl29)
#               hout['counts_metl28'].fill(sample=histAxisName, channel=ch, level=lev, counts=counts[cut_metl28], syst=syst, weight=weights_metl28)
#               hout['counts_metl27'].fill(sample=histAxisName, channel=ch, level=lev, counts=counts[cut_metl27], syst=syst, weight=weights_metl27)
#               hout['counts_metl26'].fill(sample=histAxisName, channel=ch, level=lev, counts=counts[cut_metl26], syst=syst, weight=weights_metl26)
#Fin ej qcd               
 ...
 #                     hout['mlb'].fill(sample=histAxisName, channel=ch, level=lev, mlb=mlb, syst=syst, weight=weights)
                      if fillMVA and lev in ['2j1b','3j1b','3j2b'] and self.model_2j1b is not None and len(fht) > 0:
                        ...
                        varsall=[fht,abs(u0eta)[cut],fst,fptSumVecAll,leta,fj0pt,fj0eta,u0pt[cut],u0eta[cut],ak.flatten(ptjj[cut]),fmjj,fdrjjmed,fdrjjmin,mlb[cut],mt,ptSumVeclb[cut],
                        ...
                        varsb6 = [abs(u0eta)[cut],abs(b0eta-u0eta)[cut],mtw[cut],invariant_masses[cut],fdrjjmin,mlb[cut]]
                        ...
                        varstX = [abs(u0eta)[cut],abs(b0eta-u0eta)[cut],mtw[cut],fdrjjmin,fmjj,Detalu[cut],DphiWub[cut]]
                        ...
                        MVAscore_nom_b10 = self.model_b10.predict_proba(np.column_stack(varsb10))[:,1]
                        
                        MVAscore_nom_tX = self.model_tX.predict_proba(np.column_stack(varstX))[:,1]
                        MVAscore_nom_relaxed_b10 = self.model_relaxed_b10.predict_proba(np.column_stack(varsb10))[:,1]
                        
                        

                        cutMVA_pruned=MVAscore_nom_pruned>0.5
                        cutMVA_relaxed=MVAscore_nom_relaxed_b10>0.5
                        hout['MVAscore_pruned_cut'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_pruned_cut=MVAscore_nom_pruned[cutMVA_pruned], syst=syst, weight=weights[cutMVA_pruned])
                        hout['MVAscore_relaxed_b10_cut'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_cut=MVAscore_nom_relaxed_b10[cutMVA_relaxed], syst=syst, weight=weights[cutMVA_relaxed])
                        ...
                        hout['MVAscore_b10'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_b10=MVAscore_nom_b10, syst=syst, weight=weights)
                        hout['MVAscore_tX'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_tX=MVAscore_nom_tX, syst=syst, weight=weights)
