...
dyields = {}
process = ['tt', 'tW', 'tchan','tbarchan', 'DY', 'WJetsH','WJetsL', 'QCD', 'data']
...
#categories = [r'$e^{+}$+2j1b',r'$e^{+}$+3j1b',r'$e^{+}$+3j2b',r'$e^{+}$+2j0b',r'$e^{-}$+2j1b',r'$e^{-}$+3j1b',r'$e^{-}$+3j2b',r'$e^{-}$+2j0b','$\mu^{+}+2$j1b','$\mu^{+}+3$j1b','$\mu^{+}+3$j2b','$\mu^{+}+2$j0b','$\mu^{-}+2$j1b','$\mu^{-}+3$j1b','$\mu^{-}+3$j2b','$\mu^{-}+2$j0b']#['e+3j1b', 'e+4j1b', 'e+$\geq5$j1b', 'e+3j$\geq2$b', 'e+4j$\geq2$b', 'e+$\geq5$j$\geq2$b', '$\mu+3$j1b', '$\mu+4$j1b', '$\mu+\geq5$j1b', '$\mu+3$j$\geq2$b', '$\mu+4$j$\geq2$b', '$\mu+\geq5$j$\geq2$b']
...
dyields['tchan']=dyields['tchan']+dyields['tbarchan']
