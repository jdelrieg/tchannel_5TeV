...
class AnalysisProcessor(processor.ProcessorABC):
    ...
    def __init__(self, samples, model):
        ...
        if isinstance(model, list) and len(model) >= 2:
          ...
          self.model_relaxed_b10_all = model[2]
          self.model_relaxed_b10_anal = model[3]
          self.model_relaxed_b10_25 = model[4]
          self.model_relaxed_b10_inter = model[5]
          self.model_no_mt = model[6]
        ...
        'absu0eta_ll'      : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("absu0eta_ll", "Leading u-jet $|\eta|$ ", 10, 0, 5)),
        'absu0eta_lh'      : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("absu0eta_lh", "Leading u-jet $|\eta|$ ", 10, 0, 5)),
        'absu0eta_hl'      : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("absu0eta_hl", "Leading u-jet $|\eta|$ ", 10, 0, 5)),
        'absu0eta_hh'      : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("absu0eta_hh", "Leading u-jet $|\eta|$ ", 10, 0, 5)),        
        ...
        'sumallpt'     : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("sumallpt", "H$_{T}(\ell,\mathrm{j})$ (GeV)", 10, 0, 300)),
        ...
        'MVAscore_relaxed_b10_cut'     : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("MVAscore_relaxed_b10_cut", "MVA score", 20,0,1 )),

        'MVAscore_relaxed_b10_all'     : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("MVAscore_relaxed_b10_all", "MVA score", 20,0,1 )),
        'MVAscore_relaxed_b10_all_ll'     : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("MVAscore_relaxed_b10_all_ll", "MVA score", 20,0,1 )),
        'MVAscore_relaxed_b10_all_lh'     : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("MVAscore_relaxed_b10_all_lh", "MVA score", 20,0,1 )),
        'MVAscore_relaxed_b10_all_hl'     : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("MVAscore_relaxed_b10_all_hl", "MVA score", 20,0,1 )),
        'MVAscore_relaxed_b10_all_hh'     : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("MVAscore_relaxed_b10_all_hh", "MVA score", 20,0,1 )),

        'MVAscore_relaxed_b10_anal'     : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("MVAscore_relaxed_b10_anal", "MVA score", 20,0,1 )),
        'MVAscore_relaxed_b10_25'     : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("MVAscore_relaxed_b10_25", "MVA score", 20,0,1 )),
        'MVAscore_relaxed_b10_inter'     : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("MVAscore_relaxed_b10_inter", "MVA score", 20,0,1 )),

        'MVAscore_noMt'     : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("MVAscore_noMt", "MVA score", 20,0,1 )),
        ...
        'MVAscore_relaxed_b10_ll_cut'     : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("MVAscore_relaxed_b10_ll_cut", "MVA score", 20,0,1 )),       
        ...
        'MVAscore_relaxed_b10_lh_cut'     : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("MVAscore_relaxed_b10_lh_cut", "MVA score", 20,0,1 )),       
        ...
        'MVAscore_relaxed_b10_hl_cut'     : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("MVAscore_relaxed_b10_hl_cut", "MVA score", 20,0,1 )),       
        ...
        'MVAscore_relaxed_b10_hh_cut'     : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("MVAscore_relaxed_b10_hh_cut", "MVA score", 20,0,1 )),       
...
######################################  Redefine cuts from here if wanting to add something on the w-top system ##############################################################
  ...
  ### addded             
           ...
           #    hout['DRlu'].fill(sample=histAxisName, channel=ch, level=lev, DRlu=DRlu[cut], syst=syst, weight=weights)
               ...
               if lev in ['2j1b','3j1b','3j2b']:hout['absu0eta_ll'].fill(sample=histAxisName, channel=ch, level=lev, absu0eta_ll=abs(u0eta)[cut_loweta_lowpt], syst=syst, weight=weights_frshape[cut_loweta_lowpt])
               if lev in ['2j1b','3j1b','3j2b']:hout['absu0eta_lh'].fill(sample=histAxisName, channel=ch, level=lev, absu0eta_lh=abs(u0eta)[cut_loweta_highpt], syst=syst, weight=weights_frshape[cut_loweta_highpt])
               if lev in ['2j1b','3j1b','3j2b']:hout['absu0eta_hl'].fill(sample=histAxisName, channel=ch, level=lev, absu0eta_hl=abs(u0eta)[cut_higheta_lowpt], syst=syst, weight=weights_frshape[cut_higheta_lowpt])
               if lev in ['2j1b','3j1b','3j2b']:hout['absu0eta_hh'].fill(sample=histAxisName, channel=ch, level=lev, absu0eta_hh=abs(u0eta)[cut_higheta_highpt], syst=syst, weight=weights_frshape[cut_higheta_highpt])              
...
#                   if lev in ['2j1b','3j1b','3j2b']:hout['coste_3'].fill(sample=histAxisName, channel=ch, level=lev, coste_3=cos2_abs[cut], syst=syst, weight=weights)
 ...
 #                     hout['mlb'].fill(sample=histAxisName, channel=ch, level=lev, mlb=mlb, syst=syst, weight=weights)
                      if fillMVA and lev in ['2j1b','3j1b','3j2b'] and self.model_2j1b is not None and len(fht) > 0:
                        ...
                        vars_nomt = [abs(u0eta)[cut],abs(b0eta-u0eta)[cut],invariant_masses[cut],fdrjjmed,mlb[cut],fmjj,mub[cut],fptSumVecAll,ht_atlas[cut],DptWub[cut],DphiWub[cut],Detalu[cut]]
                        ...
                        if ak.count(variables)>0:MVAscore_nom_relaxed_b10 = self.model_relaxed_b10.predict_proba(variables)[:,1];MVAscore_nom_relaxed_b10_all = self.model_relaxed_b10_all.predict_proba(variables)[:,1];MVAscore_nom_relaxed_b10_anal = self.model_relaxed_b10_anal.predict_proba(variables)[:,1];MVAscore_nom_relaxed_b10_25 = self.model_relaxed_b10_25.predict_proba(variables)[:,1];MVAscore_nom_relaxed_b10_inter = self.model_relaxed_b10_inter.predict_proba(variables)[:,1];
                        
                        variables_nomt=np.column_stack(vars_nomt)
                        if ak.count(variables_nomt)>0:MVAscore_nom_nomt=self.model_no_mt.predict_proba(variables_nomt)[:,1]
                     
                        cutMVA=MVAscore_nom_relaxed_b10_all>0.2
                        ...
                        hout['MVAscore_relaxed_b10_cut'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_cut=MVAscore_nom_relaxed_b10_all[cutMVA], syst=syst, weight=weights[cutMVA])
                        

                        hout['MVAscore_relaxed_b10_ll'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_ll=MVAscore_nom_relaxed_b10[cut_ll_truncated], syst=syst, weight=weights_ll)
                        hout['MVAscore_relaxed_b10_lh'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_lh=MVAscore_nom_relaxed_b10[cut_lh_truncated], syst=syst, weight=weights_lh)
                        hout['MVAscore_relaxed_b10_hl'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_hl=MVAscore_nom_relaxed_b10[cut_hl_truncated], syst=syst, weight=weights_hl)
                        hout['MVAscore_relaxed_b10_hh'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_hh=MVAscore_nom_relaxed_b10[cut_hh_truncated], syst=syst, weight=weights_hh) 

                        hout['MVAscore_relaxed_b10_all'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_all=MVAscore_nom_relaxed_b10_all, syst=syst, weight=weights) if len(MVAscore_nom_relaxed_b10_all)==len(weights) else hout['MVAscore_relaxed_b10_all'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_all=MVAscore_nom_relaxed_b10_all, syst=syst, weight=weights_copy)
                        hout['MVAscore_relaxed_b10_all_ll'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_all_ll=MVAscore_nom_relaxed_b10_all[cut_ll_truncated], syst=syst, weight=weights_ll)
                        hout['MVAscore_relaxed_b10_all_lh'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_all_lh=MVAscore_nom_relaxed_b10_all[cut_lh_truncated], syst=syst, weight=weights_lh)
                        hout['MVAscore_relaxed_b10_all_hl'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_all_hl=MVAscore_nom_relaxed_b10_all[cut_hl_truncated], syst=syst, weight=weights_hl)
                        hout['MVAscore_relaxed_b10_all_hh'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_all_hh=MVAscore_nom_relaxed_b10_all[cut_hh_truncated], syst=syst, weight=weights_hh) 
                        
                        hout['MVAscore_relaxed_b10_anal'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_anal=MVAscore_nom_relaxed_b10_anal, syst=syst, weight=weights) if len(MVAscore_nom_relaxed_b10_anal)==len(weights) else hout['MVAscore_relaxed_b10_anal'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_anal=MVAscore_nom_relaxed_b10_anal, syst=syst, weight=weights_copy)
                        hout['MVAscore_relaxed_b10_25'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_25=MVAscore_nom_relaxed_b10_25, syst=syst, weight=weights) if len(MVAscore_nom_relaxed_b10_25)==len(weights) else hout['MVAscore_relaxed_b10_25'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_25=MVAscore_nom_relaxed_b10_25, syst=syst, weight=weights_copy)
                        hout['MVAscore_relaxed_b10_inter'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_inter=MVAscore_nom_relaxed_b10_inter, syst=syst, weight=weights) if len(MVAscore_nom_relaxed_b10_inter)==len(weights) else hout['MVAscore_relaxed_b10_inter'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_inter=MVAscore_nom_relaxed_b10_inter, syst=syst, weight=weights_copy)                        
                        
                        hout['MVAscore_noMt'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_noMt=MVAscore_nom_nomt, syst=syst, weight=weights) if len(MVAscore_nom_nomt)==len(weights) else hout['MVAscore_noMt'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_noMt=MVAscore_nom_nomt, syst=syst, weight=weights_copy) 
...
#                   if lev in ['2j1b','3j1b','3j2b']:hout['costm_3'].fill(sample=histAxisName, channel=ch, level=lev, costm_3=cos2_abs[cut], syst=syst, weight=weights)
 ...
 #                     hout['mlb'].fill(sample=histAxisName, channel=ch, level=lev, mlb=mlb, syst=syst, weight=weights)
                      ...
                      #  if len(lpt)!=sum(cut):varsb10 = [abs(u0eta)[cut][recorte],abs(b0eta-u0eta)[cut][recorte],invariant_masses[cut][recorte],mt,fdrjjmed[recorte],mlb[cut][recorte],fmjj[recorte],mub[cut][recorte],fptSumVecAll[recorte],ht_atlas[cut][recorte],DptWub[cut][recorte],DphiWub[cut][recorte],Detalu[cut][recorte]];# print('variables',*np.column_stack(varsb10));print()
                        ...
                        MVAscore_nom_relaxed_b10_all = self.model_relaxed_b10_all.predict_proba(np.where(np.isnan(variables),-99,variables))[:,1]
                        MVAscore_nom_relaxed_b10_anal = self.model_relaxed_b10_anal.predict_proba(np.where(np.isnan(variables),-99,variables))[:,1]
                        MVAscore_nom_relaxed_b10_25 = self.model_relaxed_b10_25.predict_proba(np.where(np.isnan(variables),-99,variables))[:,1]
                        MVAscore_nom_relaxed_b10_inter = self.model_relaxed_b10_inter.predict_proba(np.where(np.isnan(variables),-99,variables))[:,1]
                        
                        variables_nomt=np.column_stack(vars_nomt)
                        MVAscore_nom_nomt = self.model_no_mt.predict_proba(np.where(np.isnan(variables_nomt),-99,variables_nomt))[:,1]
                        ...
                        hout['MVAscore_relaxed_b10_ll'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_ll=MVAscore_nom_relaxed_b10[cut_ll_truncated], syst=syst, weight=weights_ll)
                        hout['MVAscore_relaxed_b10_ll_cut'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_ll_cut=MVAscore_nom_relaxed_b10[cut_ll_truncated], syst=syst, weight=weights_ll)
                        hout['MVAscore_relaxed_b10_lh'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_lh=MVAscore_nom_relaxed_b10[cut_lh_truncated], syst=syst, weight=weights_lh)
                        hout['MVAscore_relaxed_b10_lh_cut'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_lh_cut=MVAscore_nom_relaxed_b10[cut_lh_truncated], syst=syst, weight=weights_lh)
                        hout['MVAscore_relaxed_b10_hl'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_hl=MVAscore_nom_relaxed_b10[cut_hl_truncated], syst=syst, weight=weights_hl)
                        hout['MVAscore_relaxed_b10_hl_cut'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_hl_cut=MVAscore_nom_relaxed_b10[cut_hl_truncated], syst=syst, weight=weights_hl)
                        hout['MVAscore_relaxed_b10_hh'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_hh=MVAscore_nom_relaxed_b10[cut_hh_truncated], syst=syst, weight=weights_hh)
                        hout['MVAscore_relaxed_b10_hh_cut'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_hh_cut=MVAscore_nom_relaxed_b10[cut_hh_truncated], syst=syst, weight=weights_hh)
                        
                        hout['MVAscore_relaxed_b10_all'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_all=MVAscore_nom_relaxed_b10_all, syst=syst, weight=weights)
                        hout['MVAscore_relaxed_b10_all_ll'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_all_ll=MVAscore_nom_relaxed_b10_all[cut_ll_truncated], syst=syst, weight=weights_ll)
                        hout['MVAscore_relaxed_b10_all_lh'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_all_lh=MVAscore_nom_relaxed_b10_all[cut_lh_truncated], syst=syst, weight=weights_lh)
                        hout['MVAscore_relaxed_b10_all_hl'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_all_hl=MVAscore_nom_relaxed_b10_all[cut_hl_truncated], syst=syst, weight=weights_hl)
                        hout['MVAscore_relaxed_b10_all_hh'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_all_hh=MVAscore_nom_relaxed_b10_all[cut_hh_truncated], syst=syst, weight=weights_hh)
                        
                        hout['MVAscore_relaxed_b10_anal'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_anal=MVAscore_nom_relaxed_b10_anal, syst=syst, weight=weights)
                        hout['MVAscore_relaxed_b10_25'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_25=MVAscore_nom_relaxed_b10_25, syst=syst, weight=weights)
                        hout['MVAscore_relaxed_b10_inter'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_relaxed_b10_inter=MVAscore_nom_relaxed_b10_inter, syst=syst, weight=weights) 
                        
                        hout['MVAscore_noMt'].fill(sample=histAxisName, channel=ch, level=lev, MVAscore_noMt=MVAscore_nom_nomt, syst=syst, weight=weights) 
