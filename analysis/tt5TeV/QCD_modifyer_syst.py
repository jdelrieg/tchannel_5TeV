...
cr_rates={('e_minus','2j1b'):25.38,
	...
	('e_plus','3j1b'):45.40,
	('m_minus','3j1b'):141.98,
	('m_plus','3j1b'):162.89,								#These are the normalizations in each category (N_dat^{CR}-N_MC^CR). In yields or counts
	('e_minus','3j2b'):6.14,
	('e_plus','3j2b'):3.84,
	('m_minus','3j2b'):11.42,
	('m_plus','3j2b'):8.20,
...
input_file="split_charge_goodJECs_mistag_comb_btagEff/QCD_shape/QCD_shapes.pkl.gz" #point to input file (driven from QCD mc after passing the same process as other samples, only difference the relaxation of cuts) 
#input_file="prueba/QCD_prueba.pkl.gz"
output_file = "QCD.pkl.gz"
