...
fake_rates={('e_minus','2j1b'):0.49,
	...
	('e_minus','3j2b'):0.61,
	('e_plus','3j2b'):0.47,
	('m_minus','3j2b'):0.14,								#These are the Fake rates (parte denominador)
	('m_plus','3j2b'):0.21,
		}
...
input_file = "Questions/QCD/QCD_noht_nomtw_nomet_cuts.pkl.gz"             #point to input file (driven from QCD mc after passing the same process as other samples, only difference the relaxation of cuts)
output_file = "output_scratch_nosyst.pkl.gz"
