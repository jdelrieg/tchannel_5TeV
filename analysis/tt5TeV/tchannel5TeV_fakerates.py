...
#QCD ex    
  ...
  elif 'incl_tch' in cuts:
    jetcat = ((njets == 3) & ((nbtags == 1) | (nbtags == 2))) | ((njets == 2) & (nbtags == 1))
...
class AnalysisProcessor(processor.ProcessorABC):
    ...
    def __init__(self, samples, model):
        ...
        'counts_metl25_loweta_lowpt': hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("counts",  "Counts", 1, 0, 10)),
        'counts_metl25_loweta_highpt': hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("counts",  "Counts", 1, 0, 10)),
        'counts_metl25_higheta_lowpt': hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("counts",  "Counts", 1, 0, 10)),
        'counts_metl25_higheta_highpt': hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("counts",  "Counts", 1, 0, 10)),   

        'counts_metl25_loweta': hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("counts",  "Counts", 1, 0, 10)),
        'counts_metl25_higheta': hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("counts",  "Counts", 1, 0, 10)),
        'counts_metl25_lowpt': hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("counts",  "Counts", 1, 0, 10)),
        'counts_metl25_highpt': hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("counts",  "Counts", 1, 0, 10)), 
...
########## Hists I added
        ...
        'deltaeta'         : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("deltaeta",      "Jets $\Delta \eta$ ", 16, 0, 5.0)),
...
#        '2j1b_DRlu' : processor.column_accumulator(np.array([])),
    ...
    def process(self, events):
       ...
       # selections.add('lep_plus',((events.isl_plus)&((trige)|(trigm))))
        ...
        levels = ['2j1b','3j1b','3j2b','3jg1b','incl_tch']
...
########################################################################################################                   Up to here the cut thing
              ...
              cutsnoMTW = [ch] + [lev] + ['metg30'] 
              cutjetsnomtw = GetCutJets(cutsnoMTW, syst, met_pt, njets_var, nbtags_var, nujets_var)
              cutnomtw = (cutsel) & (cutjetsnomtw) & (cutht) #& (cutmlb) 
              cutnomtw=ak.flatten(cutnomtw)
              cutnomtw = np.array(cutnomtw, dtype=bool)	
...
######################################  Redefine cuts from here if wanting to add something on the w-top system ##############################################################
              ...
              for cat in jetcategories:
               ...
               #print('lep',lep,'pt',lep.pt,'eta',lep.eta)
               ...
               lowpt_filter=lowpt[cut_metl25]
               loweta_filter=loweta[cut_metl25]
               highpt_filter=highpt[cut_metl25]
               higheta_filter=higheta[cut_metl25]
               #print('channel',ch,'level',lev,'lowpt',sum(lowpt_filter),'\n highpt',sum(highpt_filter),'\n low eta',sum(loweta_filter),'\n higheta',sum(higheta_filter))
               #print()
               #print('cut metl25',cut_metl25)
               cut_loweta_lowpt=(cut_metl25)&(loweta)&(lowpt)
               #cut_loweta_lowpt=ak.fill_none(cut_loweta_lowpt,False)
               cut_loweta_highpt=(cut_metl25)&(loweta)&(highpt)
               #cut_loweta_highpt=ak.fill_none(cut_loweta_highpt,False)
               cut_higheta_lowpt=(cut_metl25)&(higheta)&(lowpt)
               #cut_higheta_lowpt=ak.fill_none(cut_higheta_lowpt,False)
               cut_higheta_highpt=(cut_metl25)&(higheta)&(highpt)
               #cut_higheta_highpt=ak.fill_none(cut_higheta_highpt,False)
            
               
               hout['counts_metl25_loweta_lowpt'].fill(sample=histAxisName, channel=ch, level=lev, counts=counts[cut_loweta_lowpt], syst=syst, weight=weights[cut_loweta_lowpt])
               hout['counts_metl25_loweta_highpt'].fill(sample=histAxisName, channel=ch, level=lev, counts=counts[cut_loweta_highpt], syst=syst, weight=weights[cut_loweta_highpt])
               hout['counts_metl25_higheta_lowpt'].fill(sample=histAxisName, channel=ch, level=lev, counts=counts[cut_higheta_lowpt], syst=syst, weight=weights[cut_higheta_lowpt])
               hout['counts_metl25_higheta_highpt'].fill(sample=histAxisName, channel=ch, level=lev, counts=counts[cut_higheta_highpt], syst=syst, weight=weights[cut_higheta_highpt])
              
               
               cut_loweta =(cut_metl25)&(loweta)
               cut_higheta =(cut_metl25)&(higheta)
               cut_lowpt =(cut_metl25)&(lowpt)
               cut_highpt =(cut_metl25)&(highpt)                  

               hout['counts_metl25_loweta'].fill(sample=histAxisName, channel=ch, level=lev, counts=counts[cut_loweta], syst=syst, weight=weights[cut_loweta])
               hout['counts_metl25_higheta'].fill(sample=histAxisName, channel=ch, level=lev, counts=counts[cut_higheta], syst=syst, weight=weights[cut_higheta])
               hout['counts_metl25_lowpt'].fill(sample=histAxisName, channel=ch, level=lev, counts=counts[cut_lowpt], syst=syst, weight=weights[cut_lowpt])
               hout['counts_metl25_highpt'].fill(sample=histAxisName, channel=ch, level=lev, counts=counts[cut_highpt], syst=syst, weight=weights[cut_highpt])
