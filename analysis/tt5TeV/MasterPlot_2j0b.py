...
hdists   = hist.Hist("Events", hist.Cat("process", "process"), hist.Cat('syst', 'syst'), hist.Cat("channel", "channel"), hist.Bin("shapes", "Category", 8*4,-0.5,8*4-0.5))#6 + 7*5, -0.5, (6 + 7*5)-0.5)) #5->6 quitar
...
def DrawMasterQCDunc(fname, outname='qcdunc'):
    #outpath = baseweb+datatoday+'/'
    outname = 'qcdunc'
    binLabels = ['2j,1b', '3j,1b','3j,2b','2j,0b'] * 2
