...
########## Hists I added
        'ht_atlas'         : hist.Hist("Events", hist.Cat("sample", "sample"), hist.Cat("channel", "channel"), hist.Cat("level", "level"), hist.Cat('syst', 'syst'), hist.Bin("ht_atlas",      "H'$_{T}$ (GeV)", 29, 5, 440)),
...
#        '2j1b_DRlu' : processor.column_accumulator(np.array([])),
    ...
    def process(self, events):
       ...
       # selections.add('lep_plus',((events.isl_plus)&((trige)|(trigm))))
        ...
        levels = ['2j1b','3j1b','3j2b','3jg1b']#,'']#,'2j0b']#]
...
######################################  Redefine cuts from here if wanting to add something on the w-top system ##############################################################
  ...
  ### addded             
               ...
               if lev in ['2j0b','2j1b','3j1b','3j2b']:hout['Detalu'].fill(sample=histAxisName, channel=ch, level=lev, Detalu=Detalu[cut], syst=syst, weight=weights)
               #if lev in ['2j0b','2j1b','3j1b','3j2b']:hout['Detalb'].fill(sample=histAxisName, channel=ch, level=lev, Detalb=Detalb[cut], syst=syst, weight=weights)
               ...
               if lev in ['2j0b','2j1b','3j1b','3j2b']:hout['u0eta'].fill(sample=histAxisName, channel=ch, level=lev, u0eta=u0eta[cut], syst=syst, weight=weights)
               if lev in ['2j0b','2j1b','3j1b','3j2b']:hout['absu0eta'].fill(sample=histAxisName, channel=ch, level=lev, absu0eta=abs(u0eta)[cut], syst=syst, weight=weights)              
               if lev in ['2j0b','2j1b','3j1b','3j2b']:hout['u0pt'].fill(sample=histAxisName, channel=ch, level=lev, u0pt=u0pt[cut], syst=syst, weight=weights)
               ...
               if lev in ['2j0b','2j1b','3j1b','3j2b']:hout['u0mass'].fill(sample=histAxisName, channel=ch, level=lev, u0mass=u0mass[cut], syst=syst, weight=weights) 
...
#                   if lev in ['2j0b','2j1b','3j1b','3j2b']:hout['coste'].fill(sample=histAxisName, channel=ch, level=lev, coste=cost[cut], syst=syst, weight=weights)
#                   if lev in ['2j0b','2j1b','3j1b','3j2b']:hout['coste_top'].fill(sample=histAxisName, channel=ch, level=lev, coste_top=cost_top[cut], syst=syst, weight=weights)
                   
#                   if lev in ['2j0b','2j1b','3j1b','3j2b']:hout['coste_1'].fill(sample=histAxisName, channel=ch, level=lev, coste_1=cos1[cut], syst=syst, weight=weights)
                   if lev in ['2j0b','2j1b','3j1b','3j2b']:hout['coste_2'].fill(sample=histAxisName, channel=ch, level=lev, coste_2=cos2[cut], syst=syst, weight=weights)
#                   if lev in ['2j0b','2j1b','3j1b','3j2b']:hout['coste_3'].fill(sample=histAxisName, channel=ch, level=lev, coste_3=cos2_abs[cut], syst=syst, weight=weights)
...
#                   if lev in ['2j0b','2j1b','3j1b','3j2b']:hout['costm'].fill(sample=histAxisName, channel=ch, level=lev, costm=cost[cut], syst=syst, weight=weights)
#                   if lev in ['2j0b','2j1b','3j1b','3j2b']:hout['costm_top'].fill(sample=histAxisName, channel=ch, level=lev, costm_top=cost_top[cut], syst=syst, weight=weights)
                   
#                   if lev in ['2j0b','2j1b','3j1b','3j2b']:hout['costm_1'].fill(sample=histAxisName, channel=ch, level=lev, costm_1=cos1[cut], syst=syst, weight=weights)
                   if lev in ['2j0b','2j1b','3j1b','3j2b']:hout['costm_2'].fill(sample=histAxisName, channel=ch, level=lev, costm_2=cos2[cut], syst=syst, weight=weights)
#                   if lev in ['2j0b','2j1b','3j1b','3j2b']:hout['costm_3'].fill(sample=histAxisName, channel=ch, level=lev, costm_3=cos2_abs[cut], syst=syst, weight=weights)
