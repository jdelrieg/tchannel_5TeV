...
from cafea.modules.DASsearch import GetDatasetFromDAS
from cafea.modules.paths import cafea_path
from cafea.modules.fileReader import GetFiles, GetAllInfoFromFile
basepath = cafea_path("") # Just want path to cafea/cafea, not any particular file within it, so just pass "" to the function
